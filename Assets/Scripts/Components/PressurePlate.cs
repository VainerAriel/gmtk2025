...
public class PressurePlate : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (playerApproachingFromSide || ghostApproachingFromSide)
        {
    ...
    public void OnSideDeparture(bool isPlayer, bool isGhost, bool isPushableBlock)
    {
        ...
        // Debug current state
        Debug.Log($"Side departure - Player approaching: {playerApproachingFromSide}, Ghost approaching: {ghostApproachingFromSide}");
        Debug.Log($"Entities on plate - Player: {playerOnPlate}, Ghost: {ghostOnPlate}");
    ...
    {
        bool hasEntities = playerOnPlate || ghostOnPlate || 
                          playerApproachingFromSide || ghostApproachingFromSide;
        
        // Debug this check when it's called frequently
        if (hasEntities)
        {
            Debug.Log($"AreAnyEntitiesPresent: {hasEntities} - Player on: {playerOnPlate}, Ghost on: {ghostOnPlate}, Player approaching: {playerApproachingFromSide}, Ghost approaching: {ghostApproachingFromSide}");
        }
    ...
    private bool IsValidEntity(GameObject obj)
    {
        ...
        // Check if it's a player or ghost
